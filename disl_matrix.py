        ...
        for n in range(xi_len):
            ...
            for i in range(len(xylin)):
                for j in range(len(xylin)):
                    ...
                    dist[0] = abs(gv[0, i, j] - q[0])
                    dist[1] = abs(gv[1, i, j] - q[1])
                    ...
                    if rank == 0 and i == 0 and j == 0:
                        ...
                        print n, m
                        print dist[2]
                        print math.exp(-((dist[2]/1000)**2)/(2*sigmaz**2))
                        # print q[0], gv[0, i, j]
                        # print q[1], gv[1, i, j]
                        # print q[2], gv[2, i, j]
                    ...
                    matrix_part[m, n, i, j] *= math.exp(-(dist[2]/1000**2)/(2*sigmaz**2))
